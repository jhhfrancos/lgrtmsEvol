...
public class XOverLines extends ArityTwo<ProgramTree>
{
    ...
    public Vector<ProgramTree> generates(ProgramTree p, ProgramTree p1){
        ...
        Tree.Node point1 = child_1.getProgram_list().get(index1).getRoot();

        int index2 = (int) (Math.random() * child_2.getProgram_list().size());
        Tree.Node point2 = child_2.getProgram_list().get(index2).getRoot();
    ...
    public static void main(String[] args)
    {
        ...
        XOverLines xover = new XOverLines();
